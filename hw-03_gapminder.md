...
year timepoint. As observed by the final line plot, mean change in life
expectancy by continent is geegnerally on a downward slope (except
Oceania) but not to the point where mean change is negative (exception:
Africa in 1997 and 2002). Hence, we continually saw an increase in life
expectancy every timepoint. However this change is getting slighter and
not increasing as high (as seen by the first line plot - increase is
high at beginning but levels off).
